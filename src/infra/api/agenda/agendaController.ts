...
export default class AgendaController {
    ...
    public medicoAtualizaAgenda = async (
        ...
        try {
            ...
            const data = await this.agendaManagerUseCase.medicoAtualizaAgenda(body.agendaId, body.data, body.horario, token.idPerfil, body.pacienteId);
    ...
    public pacienteAgendaConsulta = async (
        ...
        try {
            ...
            const data = await this.agendaManagerUseCase.pacienteAgendaConsulta(body.agendaId, body.pacienteId);
    ...
    public buscarAgendasDeUmMedico = async (
        ...
        try {
            ...
            Logger.error(`Error in GET /agenda/{medicoId}: ${error.message}`);
            return h.response({ error: 'Internal Server Error' }).code(500)
        }
